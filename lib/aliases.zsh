...
[ -d ~/Developer/Forks ]       && alias dvf='cd ~/Developer/Forks'
[ -d ~/Developer/Jobs ]         && alias dvj='cd ~/Developer/Jobs'
[ -d ~/Developer/Playground ]  && alias dvp='cd ~/Developer/Playground'
[ -d ~/Developer/Repos ]       && alias dvr='cd ~/Developer/Repos'
